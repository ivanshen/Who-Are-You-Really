...
public class CompositeTitle extends Title implements Cloneable, Serializable {
    ...
    public Size2D arrange(Graphics2D g2, RectangleConstraint constraint) {
        Size2D contentSize = this.container.arrange(g2, toContentConstraint(constraint));
    ...
    public Object draw(Graphics2D g2, Rectangle2D area, Object params) {
        ...
        return this.container.draw(g2, trimPadding(area), params);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.container.equals(that.container) && PaintUtilities.equal(this.backgroundPaint, that.backgroundPaint)) {
