...
public class XYLineAnnotation extends AbstractXYAnnotation implements Cloneable, PublicCloneable, Serializable {
    ...
    public XYLineAnnotation(double x1, double y1, double x2, double y2) {
        this(x1, y1, x2, y2, new BasicStroke(Plot.DEFAULT_FOREGROUND_ALPHA), Color.black);
    }
    ...
    public void draw(Graphics2D g2, XYPlot plot, Rectangle2D dataArea, ValueAxis domainAxis, ValueAxis rangeAxis, int rendererIndex, PlotRenderingInfo info) {
        ...
        Line2D line = new Float(j2DX1, j2DY1, j2DX2, j2DY2);
        ...
        if (toolTip != null || url != null) {
            addEntity(info, ShapeUtilities.createLineRegion(line, Plot.DEFAULT_FOREGROUND_ALPHA), rendererIndex, toolTip, url);
        }
    }
