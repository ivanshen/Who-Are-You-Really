...
public class StandardGradientPaintTransformer implements GradientPaintTransformer, Cloneable, PublicCloneable, Serializable {
    ...
    public GradientPaint transform(GradientPaint paint, Shape target) {
        ...
        if (this.type.equals(GradientPaintTransformType.VERTICAL)) {
            return new GradientPaint((float) bounds.getCenterX(), (float) bounds.getMinY(), paint.getColor1(), (float) bounds.getCenterX(), (float) bounds.getMaxY(), paint.getColor2());
        }
        if (this.type.equals(GradientPaintTransformType.HORIZONTAL)) {
            return new GradientPaint((float) bounds.getMinX(), (float) bounds.getCenterY(), paint.getColor1(), (float) bounds.getMaxX(), (float) bounds.getCenterY(), paint.getColor2());
        }
        if (this.type.equals(GradientPaintTransformType.CENTER_HORIZONTAL)) {
            return new GradientPaint((float) bounds.getCenterX(), (float) bounds.getCenterY(), paint.getColor2(), (float) bounds.getMaxX(), (float) bounds.getCenterY(), paint.getColor1(), true);
        }
        if (this.type.equals(GradientPaintTransformType.CENTER_VERTICAL)) {
            return new GradientPaint((float) bounds.getCenterX(), (float) bounds.getMinY(), paint.getColor1(), (float) bounds.getCenterX(), (float) bounds.getCenterY(), paint.getColor2(), true);
        }
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.type != ((StandardGradientPaintTransformer) obj).type) {
            return false;
        }
        return true;
    }
